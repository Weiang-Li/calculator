...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(476, 392))
        MainWindow.setMaximumSize(QtCore.QSize(476, 392))
...
"}")
        ...
        self.pushButton = QtWidgets.QPushButton(self.TopFrame)
        self.pushButton.setMinimumSize(QtCore.QSize(88, 0))
        self.pushButton.setObjectName("pushButton")
        self.gridLayout_2.addWidget(self.pushButton, 0, 1, 1, 1)
        self.pushButton_2 = QtWidgets.QPushButton(self.TopFrame)
        self.pushButton_2.setMinimumSize(QtCore.QSize(88, 0))
        self.pushButton_2.setObjectName("pushButton_2")
        self.gridLayout_2.addWidget(self.pushButton_2, 0, 2, 1, 1)
        self.Screen_LE = QtWidgets.QLineEdit(self.TopFrame)
        self.Screen_LE.setMinimumSize(QtCore.QSize(0, 40))
        self.Screen_LE.setObjectName("Screen_LE")
        self.gridLayout_2.addWidget(self.Screen_LE, 1, 0, 1, 3)
        self.gridLayout_3.addWidget(self.TopFrame, 0, 0, 1, 1)
        ...
        self.nb8 = QtWidgets.QPushButton(self.buttonFrame)
        self.nb8.setMinimumSize(QtCore.QSize(88, 50))
        self.nb8.setObjectName("nb8")
        self.gridLayout.addWidget(self.nb8, 2, 1, 1, 1)
        self.plus = QtWidgets.QPushButton(self.buttonFrame)
        self.plus.setMinimumSize(QtCore.QSize(88, 50))
        self.plus.setObjectName("plus")
        self.gridLayout.addWidget(self.plus, 0, 3, 1, 1)
        self.dash = QtWidgets.QPushButton(self.buttonFrame)
        self.dash.setMinimumSize(QtCore.QSize(88, 50))
        self.dash.setObjectName("dash")
        self.gridLayout.addWidget(self.dash, 3, 2, 1, 1)
        self.nb0 = QtWidgets.QPushButton(self.buttonFrame)
        self.nb0.setMinimumSize(QtCore.QSize(88, 50))
        self.nb0.setObjectName("nb0")
        self.gridLayout.addWidget(self.nb0, 3, 0, 1, 1)
        self.minus = QtWidgets.QPushButton(self.buttonFrame)
        self.minus.setMinimumSize(QtCore.QSize(88, 50))
        self.minus.setObjectName("minus")
        self.gridLayout.addWidget(self.minus, 1, 3, 1, 1)
        self.dot = QtWidgets.QPushButton(self.buttonFrame)
        self.dot.setMinimumSize(QtCore.QSize(88, 50))
        self.dot.setObjectName("dot")
        self.gridLayout.addWidget(self.dot, 3, 1, 1, 1)
        self.nb2 = QtWidgets.QPushButton(self.buttonFrame)
        self.nb2.setMinimumSize(QtCore.QSize(88, 50))
        self.nb2.setObjectName("nb2")
        self.gridLayout.addWidget(self.nb2, 0, 1, 1, 1)
        self.mul = QtWidgets.QPushButton(self.buttonFrame)
        self.mul.setMinimumSize(QtCore.QSize(88, 50))
        self.mul.setObjectName("mul")
        self.gridLayout.addWidget(self.mul, 2, 3, 1, 1)
        self.divide = QtWidgets.QPushButton(self.buttonFrame)
        self.divide.setMinimumSize(QtCore.QSize(88, 50))
        self.divide.setObjectName("divide")
        self.gridLayout.addWidget(self.divide, 3, 3, 1, 1)
        self.nb4 = QtWidgets.QPushButton(self.buttonFrame)
        self.nb4.setMinimumSize(QtCore.QSize(88, 50))
        self.nb4.setObjectName("nb4")
        self.gridLayout.addWidget(self.nb4, 1, 0, 1, 1)
        self.nb5 = QtWidgets.QPushButton(self.buttonFrame)
        self.nb5.setMinimumSize(QtCore.QSize(88, 50))
        self.nb5.setObjectName("nb5")
        self.gridLayout.addWidget(self.nb5, 1, 1, 1, 1)
        self.nb1 = QtWidgets.QPushButton(self.buttonFrame)
        self.nb1.setMinimumSize(QtCore.QSize(88, 50))
        self.nb1.setObjectName("nb1")
        self.gridLayout.addWidget(self.nb1, 0, 0, 1, 1)
        self.nb6 = QtWidgets.QPushButton(self.buttonFrame)
        self.nb6.setMinimumSize(QtCore.QSize(88, 50))
        self.nb6.setObjectName("nb6")
        self.gridLayout.addWidget(self.nb6, 1, 2, 1, 1)
        self.nb3 = QtWidgets.QPushButton(self.buttonFrame)
        self.nb3.setMinimumSize(QtCore.QSize(88, 50))
        self.nb3.setObjectName("nb3")
        self.gridLayout.addWidget(self.nb3, 0, 2, 1, 1)
        self.nb9 = QtWidgets.QPushButton(self.buttonFrame)
        self.nb9.setMinimumSize(QtCore.QSize(88, 50))
        self.nb9.setObjectName("nb9")
        self.gridLayout.addWidget(self.nb9, 2, 2, 1, 1)
        self.nb7 = QtWidgets.QPushButton(self.buttonFrame)
        self.nb7.setMinimumSize(QtCore.QSize(88, 50))
        self.nb7.setObjectName("nb7")
        self.gridLayout.addWidget(self.nb7, 2, 0, 1, 1)
        self.gridLayout_3.addWidget(self.buttonFrame, 1, 0, 1, 1)
        self.gridLayout_4.addWidget(self.frame, 0, 0, 1, 1)
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 476, 30))
        ...
        self.nb0.clicked.connect(lambda: self.display_screen('0'))
        self.nb1.clicked.connect(lambda: self.display_screen('1'))
        self.nb2.clicked.connect(lambda: self.display_screen('2'))
        self.nb3.clicked.connect(lambda: self.display_screen('3'))
        self.nb4.clicked.connect(lambda: self.display_screen('4'))
        self.nb5.clicked.connect(lambda: self.display_screen('5'))
        self.nb6.clicked.connect(lambda: self.display_screen('6'))
        self.nb7.clicked.connect(lambda: self.display_screen('7'))
        self.nb8.clicked.connect(lambda: self.display_screen('8'))
        self.nb9.clicked.connect(lambda: self.display_screen('9'))
        self.dot.clicked.connect(lambda: self.display_screen('.'))

        self.plus.clicked.connect(lambda: self.display_screen('+'))
        self.minus.clicked.connect(lambda: self.display_screen('-'))
        self.mul.clicked.connect(lambda: self.display_screen('*'))
        self.divide.clicked.connect(lambda: self.display_screen('/'))

        self.pushButton_2.clicked.connect(self.Screen_LE.clear)
        self.pushButton.clicked.connect(self.Screen_LE.backspace)
        self.dash.clicked.connect(self.calculation)
    ...
    def calculation(self):
        try:
            screen_value = str(self.Screen_LE.text())
            print(screen_value)
            ans = eval(screen_value)
            print(ans)
            self.Screen_LE.setText(str(ans))
